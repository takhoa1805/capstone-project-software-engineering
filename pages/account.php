...
<div class="container mainContainer">
  <div class="MyAccount-container">
    ...
    <div class="Password-container">
      <div style="width: 100px; color: black; font-size: 24px; font-family: Inconsolata; font-weight: 700; word-wrap: break-word">Password</div>
  ...
  <div class="Product-SellRequest">
    ...
    <div class="AccountInfo">
      <div class="Frame96">
        <div class="Frame95">
          <form style="gap: 10px; display: flex; flex-direction: column; padding-bottom: 10px;">
